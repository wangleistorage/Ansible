#!/bin/sh
JAVA_OPTS="-server -Xms512m -Xmx512m -XX:PermSize=128m -XX:MaxNewSize=256m -XX:MaxPermSize=256m -Duser.timezone=GMT+08 -Djava.net.preferIPv4Stack=true -Djava.awt.headless=true -DserverId=SERVER_ID"
